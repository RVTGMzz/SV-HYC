...
internal sealed class SudokuConversationMenu : IClickableMenu
{
    ...
    private static int GetMenuWidth() => Math.Clamp(Game1.viewport.Width - 96, 620, 800);
    private static int GetMenuHeight() => Math.Clamp(Game1.viewport.Height - 120, 430, 540);
