...
internal sealed partial class ModEntry
{
    ...
    private void ShowSudokuGiftOffer()
    {
        ...
        // Keep story anchors, tools, weapons, and furniture outside this custom gift flow.
    ...
    private void ConsumeOneGiftItem(Item gift)
    {
        ...
        // Defensive fallback for mods which replace the held stack while confirmation is open.
        for (int i = 0; i < Game1.player.Items.Count; i++)
        {
            Item? item = Game1.player.Items[i];
